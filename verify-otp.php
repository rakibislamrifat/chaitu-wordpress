...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$input_otp) {
        ...
        if ($db_otp === null) {
            ...
            header('Location: http://localhost/Chaitu-Wordpress/wordpress/reset-password');
            exit;
        } else {
...
<body>
    ...
    <div class="chaitu-container">
        ...
        <form method="POST" action="http://localhost/Chaitu-Wordpress/wordpress/verify-otp" novalidate>
