...
if (!isset($_SESSION['reset_email'])) {
    header('Location: http://localhost/Chaitu-Wordpress/wordpress/forgot-password');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($exec) {
            ...
            $success = "Password reset successfully. You can now <a href='http://localhost/Chaitu-Wordpress/wordpress/sign-in' class='chaitu-link'>login</a>.";
        } else {
...
<body class="chaitu-body">
    <div class="chaitu-container">
        ...
        <?php else: ?>
            ...
            <form method="POST" action="http://localhost/Chaitu-Wordpress/wordpress/reset-password" novalidate>
