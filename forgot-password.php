    ...
    if (!$email || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user_id) {
            ...
            try {
                ...
                header('Location: http://localhost/Chaitu-Wordpress/wordpress/verify-otp');
                exit;
            } catch (Exception $e) {
...
<body class="chaitu-body">
    <div class="chaitu-container">
        ...
        <form method="POST" action="http://localhost/Chaitu-Wordpress/wordpress/forgot-password" novalidate>
